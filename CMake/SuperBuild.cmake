...
# This allows switching branches in the PBREG source code and build PBREG quickly, even if the
...
# PBREG-configure timestamp manually before doing a superbuild. Without that the CMake cache is
...
set(EP_COMMON_ARGS
  ...
  "-DCMAKE_CXX_FLAGS:STRING=${CMAKE_CXX_FLAGS} ${PBREG_CXX11_FLAG}"
  #debug flags
...
set(PBREG_SUPERBUILD_DEBUG_POSTFIX d)
...
######################################################################
include(pbrExternalProjectHelperMacros)
...
######################################################################
# Now compile PBREG, using the packages we just provided.
######################################################################
if(NOT DEFINED SUPERBUILD_EXCLUDE_PBREGBUILD_TARGET OR NOT SUPERBUILD_EXCLUDE_PBREGBUILD_TARGET)
  ...
  ExternalProject_Add(${proj}
    ...
    CMAKE_ARGS
      ...
      -DPBREG_SUPERBUILD_DEBUG_POSTFIX:STRING=${PBREG_SUPERBUILD_DEBUG_POSTFIX}
    CMAKE_CACHE_ARGS
      ${EP_COMMON_CACHE_ARGS}
      -DCMAKE_LIBRARY_PATH:PATH=${CMAKE_LIBRARY_PATH}
      -DCMAKE_INCLUDE_PATH:PATH=${CMAKE_INCLUDE_PATH}
      -DPBREG_EXTERNAL_PROJECT_PREFIX:PATH=${ep_prefix}
      -DPBREG_USE_KWSTYLE:BOOL=${PBREG_USE_KWSTYLE}
      -DPBREG_USE_CPPCHECK:BOOL=${PBREG_USE_CPPCHECK}
      -DPBREG_USE_QT:BOOL=${PBREG_USE_QT}
      -DPBREG_USE_OPENMP:BOOL=${PBREG_USE_OPENMP}
      -DPBREG_USE_CUDA:BOOL=${PBREG_USE_CUDA}
      -DPBREG_DELAYLOAD_CUDA:BOOL=${PBREG_DELAYLOAD_CUDA}
      -DPBREG_CUDA_ARCH_BIN:STRING=${PBREG_CUDA_ARCH_BIN}
      -DCUDA_TOOLKIT_ROOT_DIR:PATH=${CUDA_TOOLKIT_ROOT_DIR}
      -DPBREG_USE_MPI:BOOL=${PBREG_USE_MPI}
      -DCMAKE_INSTALL_PREFIX:PATH=${CMAKE_INSTALL_PREFIX}
      "-DCMAKE_INSTALL_RPATH:STRING=${_install_rpath}"
      -DCMAKE_VERBOSE_MAKEFILE:BOOL=${CMAKE_VERBOSE_MAKEFILE}
      -DBUILD_TESTING:BOOL=${BUILD_TESTING} # The value set in EP_COMMON_ARGS normally forces this off, but we may need PBREG to be on.
