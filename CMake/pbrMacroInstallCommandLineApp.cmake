...
macro(PBREG_INSTALL_CL)

  set(ARGS ${ARGN})
  list(FIND ARGS DESTINATION _destination_index)
  if(_destination_index GREATER -1)
    message(SEND_ERROR "PBREG_INSTALL_CL macro must not be called with a DESTINATION parameter.")
  else()
    ...
    if(NOT _app_installed)
      install(${ARGS} DESTINATION ${PBREG_INSTALL_BIN_DIR})
    endif()
