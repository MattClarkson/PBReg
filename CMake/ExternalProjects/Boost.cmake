...
set(PBREG_USE_Boost 1)
set(PBREG_USE_Boost_LIBRARIES ${PBREG_BOOST_LIBS})
...
string(REPLACE "^^" ";" PBREG_USE_Boost_LIBRARIES "${PBREG_USE_Boost_LIBRARIES}")

if(NOT DEFINED BOOST_ROOT AND NOT PBREG_USE_SYSTEM_Boost)
  ...
  if(PBREG_USE_Boost_LIBRARIES)
    string(REPLACE ";" "," _boost_libs "${PBREG_USE_Boost_LIBRARIES}")
    foreach(_boost_lib ${PBREG_USE_Boost_LIBRARIES})
  ...
  set(_boost_cxxflags )
  if(CMAKE_CXX_FLAGS OR PBREG_CXX11_FLAG)
    set(_boost_cxxflags "cxxflags=${PBREG_CXX11_FLAG} ${CMAKE_CXX_FLAGS}")
  endif()
  ...
  # Manual install commands (for a PBREG super-build install)
