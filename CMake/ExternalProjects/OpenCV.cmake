...
if(NOT DEFINED OpenCV_DIR)
  ...
  set(_cuda_options
    -DWITH_CUDA:BOOL=${PBREG_USE_CUDA}
  )
  if(PBREG_USE_CUDA)
    ...
    if(CMAKE_COMPILER_IS_GNUCXX)
      list(APPEND _cuda_options -DCUDA_NVCC_FLAGS:STRING=${PBREG_CXX11_FLAG}^^--expt-relaxed-constexpr)
    else()
      list(APPEND _cuda_options -DCUDA_NVCC_FLAGS:STRING=${PBREG_CXX11_FLAG})
    endif()
  endif()
  ...
  ExternalProject_Add(${proj}
    ...
    CMAKE_ARGS
      ...
      -DWITH_OPENMP:BOOL=${PBREG_USE_OPENMP}
      ${_vtk_options}
      ${_cuda_options}
      "-DCMAKE_CXX_FLAGS:STRING=${CMAKE_CXX_FLAGS} ${PBREG_CXX11_FLAG} -DVTK_MAJOR_VERSION=6" # Doesn't matter what version, as long as > 5.
