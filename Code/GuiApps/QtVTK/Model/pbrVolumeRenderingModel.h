...
#ifndef pbrVolumeRenderingModel_h
#define pbrVolumeRenderingModel_h

#include "pbrQtVTKModelWin32ExportHeader.h"
...
*/
  class PBREG_QTVTKMODELWINEXPORT VolumeRenderingModel : public QObject
{
  Q_OBJECT
