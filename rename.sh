...
# Script which changes generic name PBReg, namespace pbr etc to a project name of your choice.
...
NEW_PROJECT_NAME_CAMEL_CASE='PBReg'
NEW_PROJECT_NAME_LOWER_CASE='pbreg'
NEW_PROJECT_NAME_CAPS='PBREG'
NEW_SHORT_DESCRIPTION='A software package for point based registration, including ICP for surfaces.'
NEW_NAMESPACE='pbr'
...
OLD_PROJECT_NAME_CAMEL_CASE='PBReg'
OLD_PROJECT_NAME_LOWER_CASE='pbreg'
OLD_PROJECT_NAME_CAPS='PBREG'
OLD_DOXYGEN_INTRO='A software package for point based registration, including ICP for surfaces.'
OLD_SHORT_DESCRIPTION='A software package for point based registration, including ICP for surfaces.'
OLD_NAMESPACE='mp'
...
# Replace name PBReg, pbreg, PBREG etc.
